...
<tileset version="1.10" tiledversion="1.10.2" name="sandstone_tileset" tilewidth="32" tileheight="32" spacing="8" margin="4" tilecount="12" columns="4">
 <image source="../images/Sandstone tileset 4px border.png" width="160" height="120"/>
 <tile id="3">
  <properties>

 ...
 */
public class NPCRoamingMovementStyle extends MovementStyle {
    ...
    public NPCRoamingMovementStyle(Actor npc, String... path) {
        this.npc = npc;
        this.path = path;
        lastDirection = '-';
    ...
    public NPCRoamingMovementStyle(Actor npc) {
        this(npc, "-" );
    }

...
public class Bullet extends Actor {
    ...
    public Bullet(Texture t, float width, float height, float nozzleX, float nozzleY, float speed, int time) {
        sprite = new Sprite(t);
    ...
    public Bullet(Texture t, float width, float height, float nozzleX, float nozzleY, int time) {
        this(t, width, height, nozzleX, nozzleY, 500, time);
    }

    public Bullet(Texture t, float width, float height, float nozzleX, float nozzleY, float speed) {
        this(t, width, height, nozzleX, nozzleY, speed, 150);
    }

    public Bullet(Texture t, float width, float height, float nozzleX, float nozzleY) {
